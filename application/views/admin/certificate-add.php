          ...
          <div class="">
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('add_certificate'); ?></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open_multipart('hr/createcertificate', $attributes);
					?>
                    <!--<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
					 ...
					 <div class="form-group">
						<?php
							...
							echo form_label(lang('user').' <span class="required">*</span>','user',$data);
						?>
						...
						<?php
							...
							echo form_dropdown('user', $ourtypes, array(), 'class="form-control" required="required"');
						?>
                        </div>
                      </div>
                      <div class="form-group">
					   ...
					   <div class="form-group">
						<?php
							...
							echo form_label(lang('file').' <span class="required">*</span>','file',$data);
						?>
                        <div class="col-md-6 col-md-pull-1 col-sm-6 col-sm-pull-2 col-xs-12">
						  <?php
							$data = array(
