          ...
          <div class="">
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('add_item'); ?></h3>
              </div>
					...
					<div class="form-group">
					  ...
					  <div class="form-group">
						...
						<?php
							...
							echo form_dropdown('type', $ourtypes1, array(), 'id="/*type*/" class="form-control"');
						?>
                        </div>
                      </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
						...
						<?php
							if(!empty($delegates))
							{
								...
								echo form_dropdown('delegate', $ourtypes3, array(), 'class="form-control"');
							}
                        ...
                        <div class="col-md-6 col-md-pull-1 col-sm-6 col-sm-pull-2 col-xs-12">
						  <?php
							$data = array(
								...
								//'max' => 11,
								//'required' => 'required',
								'value' => set_value('wholesaleprice')
							);
							echo form_input($data);
							echo $system->currency;
						?>
