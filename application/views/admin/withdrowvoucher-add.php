          ...
          <div class="">
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('add_withdrowvoucher'); ?></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open('withdrowvouchers/create', $attributes);
					?>
                    <!--<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-md-pull-1 col-sm-6 col-sm-pull-2 col-xs-12">
							<input list="bills" oninput="onInput(this)" id="bill" name="order" maxlength="25" onkeyup="/*showResult(this.value)*/" class="form-control" autocomplete="off" required="required"><datalist id="bills"><?php foreach($bills as $bill) { ?><option value="<?php echo $bill->boid; ?>" bill="<?php echo $bill->bid; ?>" customer="<?php echo $bill->customer; ?>" total="<?php echo $bill->btotal; ?>" newtotal="<?php echo $bill->bnewtotal; ?>"><?php echo $bill->ocode.' | '.$bill->customer; ?></option><?php } ?></datalist>
                        </div>
                      </div>
