          ...
          <div class="">
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('paymentvouchersdate'); ?></h3>
              </div>
				...
				<div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12">
					<table id="" class="table table-striped table-bordered"  dir="rtl">
						<tr>
							...
							<td><?php echo ArabicTools::arabicDate($system->calendar.' Y-m-d', time($id)); ?></td>
						</tr>
					</table>
				</div>
			</div>
			...
			<?php
				...
				echo form_open_multipart('paymentvouchers/date/'.$id, $attributes);
			?>
			<div class="row">
				<div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12">
