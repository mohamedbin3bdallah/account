					...
					<table id="datatable-buttons" class="table table-striped table-bordered">
					  ...
					  <?php foreach($usertypes as $usertype) { ?>
                        <tr>
						  ...
						  <td><?php echo ArabicTools::arabicDate($system->calendar.' Y-m-d', $usertype->utctime).' , '.date('h:i:s', $usertype->utctime); if(date('H', $usertype->utctime) < 12) echo ' '.lang('am'); else echo ' '.lang('pm'); ?></td>
						  <td><input type="checkbox" <?php if($usertype->active == 1) echo 'checked'; ?> disabled></td>
