...
*/
      ...
      var data = {
        labels: [
          "<?php echo $itemtypes[0]['item']; ?> ",
          "<?php echo $itemtypes[1]['item']; ?> ",
          "<?php echo $itemtypes[2]['item']; ?> ",
          "<?php echo $itemtypes[3]['item']; ?> ",
          "<?php echo $itemtypes[4]['item']; ?> "
        ],
        datasets: [{
          data: [
			<?php echo $itemtypes[0]['sum']; ?>,
			<?php echo $itemtypes[1]['sum']; ?>,
			<?php echo $itemtypes[2]['sum']; ?>,
			<?php echo $itemtypes[3]['sum']; ?>,
			<?php echo $itemtypes[4]['sum']; ?>
			],
          backgroundColor: [
