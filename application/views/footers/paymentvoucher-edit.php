<!-- footer content -->
	...
	$(document).ready(function(){
		$("#type").change(function(){
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo base_url(); ?>paymentvouchers/getmodels',
				data: {
					'val':val,
				},
				success: function (response) { document.getElementById("model").innerHTML = response; document.getElementById("item").innerHTML = ''; document.getElementById("quantity").value = ''; $('#quantity').prop('readonly', true); }
			});
		});
	});
	...
	$(document).ready(function(){
		$("#model").change(function(){
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo base_url(); ?>paymentvouchers/getitems',
				data: {
					'val':val,
				},
				success: function (response) { document.getElementById("item").innerHTML = response; document.getElementById("quantity").value = ''; $('#quantity').prop('readonly', true); }
			});
		});
	});
	...
	$(document).ready(function(){
		$("#item").change(function(){
			...
			var quantity = parseInt(element.attr('quantity'));
	...
	/*$(document).ready(function(){
		$("#quantity").keyup(function(){
			...
			var element = $("#item").find('option:selected');
			var itemquantity = parseInt(element.attr('quantity'));
			var newitemid = element.val();
			var olditemid = $("#olditemid").val();
			if(newitemid == olditemid)
			{
				var olditemq = $("#olditemq").val();
				document.getElementById("newitemquantity").value = olditemq-quantity;
			}
			else
			{
				document.getElementById("newitemquantity").value = itemquantity-quantity;
			}
		});
	});*/
	</script>
