<!-- footer content -->
	...
	function onInput(j)
		{
			var opts = document.getElementById('bills').childNodes;
			...
			for (var i = 0; i < opts.length; i++)
			{
				if (opts[i].value === j.value) {
					/*document.getElementById('bill').innerHTML = opts[i].getAttribute("bill");
					document.getElementById('bill').value = opts[i].getAttribute("bill");*/
			
					document.getElementById('customer').innerHTML = opts[i].getAttribute("customer");
					document.getElementById('customer').value = opts[i].getAttribute("customer");
			
					document.getElementById('newtotal').innerHTML = opts[i].getAttribute("newtotal");
					document.getElementById('newtotal').value = opts[i].getAttribute("newtotal");
				}
			}
		}
		...
		$(document).ready(function(){
			$('#payment').keyup(function () {
				...
				if(parseFloat(newtotal) >= parseFloat(payment)) $("#submit").removeAttr("disabled");
